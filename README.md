...
|[12_Исследование надежности заемщиков](https://github.com/MikalaiKhilko/DS_projecs/tree/main/12_Borrower_reliability_study)|Исследование факторов, влияющих на возврат/невозврат кредита в срок для создания модели кредитного скоринга|pandas, matplotlib|
|[13_Исследование продаж компьютерных игр]|Анализ рынка игр и платформ в Европе, Северной Америке и Японии для планирования рекламной кампании|pandas, matplotlib, seaborn, numpy, scipy|
