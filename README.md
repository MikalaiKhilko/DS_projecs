...
В репозитории собраны выполненные проекты по направлению Data Science.
Данные проекты были выполнены в ходе обучения в Yandex.Practicum профессии "Специалист по Data Science".
...
|Определение наиболее выгодного региона нефтедобычи|Предобработка данных, построение моделей, определяющих регион с наиболее выгодной добычей нефти на основе характеристик скважин в регионах|pandas, matplotlib, numpy, seaborn, sklearn|
