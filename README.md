...
|Определение возраста по фотографии (компьютерное зрение)|Построение модели, предсказывающей возраст покупателя по фотографии, чтобы анализировать покупки и предлагать товары, которые могут заинтересовать покупателей этой возрастной группы и контролировать добросовестность кассиров при продаже алкоголя|pandas, keras, matplotlib, numpy, seaborn|
