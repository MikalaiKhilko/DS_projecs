...
|[05_Классификация комментариев (машинное обучение для текстов)](https://github.com/MikalaiKhilko/DS_projecs/tree/main/05_Comment_classification)|Предобработка текста, построение  модели, позволяющей классифицировать токсичность комментариев|pandas, sklearn, numpy, nltk, tf-idf, lightgbm|
