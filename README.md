...
|[07_Определение перспективного тарифа для оператора сотовой связи](https://github.com/MikalaiKhilko/DS_projecs/tree/main/07_Determination_best_tariff_for_mobile_operator)|Предобработка и анализ данных о поведении клиентов, проверка гипотез о различии выручки в зависимости от тарифа и от региона|pandas, matplotlib, numpy, seaborn|
|[07_Определение перспективного тарифа для оператора сотовой связи](https://github.com/MikalaiKhilko/DS_projecs/tree/main/07_Determination_best_tariff_for_mobile_operator)|Предобработка и анализ данных о поведении клиентов, проверка гипотез о различии выручки в зависимости от тарифа и от региона|pandas, matplotlib, numpy, seaborn|
