...
|[Определение наиболее выгодного региона нефтедобычи](https://github.com/MikalaiKhilko/DS_projecs/tree/main/03_Prediction_of_oil_volume_in_wells)|Построение моделей, определяющих регион с наиболее выгодной добычей нефти на основе характеристик скважин в регионах|pandas, matplotlib, numpy, seaborn, sklearn|
