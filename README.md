...
|[04_Классификация комментариев (машинное обучение для текстов)](https://github.com/MikalaiKhilko/DS_projecs/blob/main/04_Forecasting_taxi_orders)|Предобработка текста, построение  модели, позволяющей классифицировать токсичность комментариев|pandas, sklearn, numpy, nltk, tf-idf, ightgbm|
