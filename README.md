...
|[05_Классификация комментариев (машинное обучение для текстов)]|Предобработка текста, построение  модели, позволяющей классифицировать токсичность комментариев|pandas, sklearn, numpy, nltk, tf-idf, ightgbm|
